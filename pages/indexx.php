...
<div align="center" data-role="main" class="ui-content">
  ...
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav navbar-right">
      ...
      <li class="active"><a href="logout.php"><span class="glyphicon glyphicon-log-out"></span> Login</a></li>
    </ul>
  </div>
</nav></td>
		</tr>
 ...
 <div align="center"  data-role="page" id="pageone">
				<table border="1" width="53%" style="border-width: 0px">
					<tr>
						...
						<div align="center">
							<table border="1" cellpadding="0" cellspacing="0" width="561" bordercolorlight="#008080" bordercolordark="#C0C0C0" style="border-width: 0px">
								<tr>
									<td style="border-style: none; border-width: medium">
									<div class="panel panel-info">
										<div class="panel-heading">
											<p align="center">
											<font face="Berlin Sans FB" size="6" color="#FF0000">
											Customer Login</font></div>
