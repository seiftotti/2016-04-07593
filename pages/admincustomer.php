...
<li ><a href="admin.php"><span class="glyphicon glyphicon-comment"></span> View Comment</a></li>
    <li class="active" ><a href="register.php" target ="ok"><span class="glyphicon glyphicon-user"></span> View Customer</a></li>
<li><a href="order.php"><span class="glyphicon glyphicon-th-large"></span> View Order</a></li>
 ...
 <div align="center"  data-role="page" id="pageone"><br>
				...
				<table border="0" cellpadding="0" cellspacing="0" width="418" bordercolorlight="#008080" bordercolordark="#C0C0C0">
					<tr>
						<td>
						<iframe frameborder ="no" scrolling ="yes" name="ok" width="784" height ="507" src="register.php" ></iframe>
						</td>
					</tr>
	</table>
